...
public class JavaSpark11 implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        Dataset<Row> data = spark.read().csv("C:\\Users\\Vijay Kumar\\IdeaProjects\\Mission_2022\\src\\data\\emp.csv");
//        Dataset<String> data = spark.read().textFile("C:\\Users\\Vijay Kumar\\IdeaProjects\\Mission_2022\\src\\data\\emp.txt");
        data.show();
